...
builder.Services.AddSingleton<RecommendationRefreshQueue>();
builder.Services.AddSingleton<IRecommendationRefreshQueue>(sp => sp.GetRequiredService<RecommendationRefreshQueue>());
builder.Services.AddHostedService<RecommendationRefreshBackgroundService>();
